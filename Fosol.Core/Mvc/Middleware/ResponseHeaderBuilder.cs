using Fosol.Core.Mvc.Middleware.Constants;
using System;

namespace Fosol.Core.Mvc.Middleware
{
    /// <summary>
    /// ResponseHeaderBuilder class, provides a way to configure response header middleware.
    /// </summary>
    public class ResponseHeaderBuilder
    {
        #region Variables
        private readonly ResponseHeaderPolicy _policy = new ResponseHeaderPolicy();
        ...
        #region Constructors
        /// <summary>
        /// Creates a new instance of a ResponseHeaderBuilder object.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of a ResponseHeaderBuilder object, and initializes it with the specified options.
        /// </summary>
        /// <param name="options"></param>
        public ResponseHeaderBuilder(Action<ResponseHeaderBuilder> options)
        {
            options?.Invoke(this);
        }
        #endregion
        ...
        /// </summary>
        public ResponseHeaderBuilder AddDefaultSecurePolicy()
        {
            AddFrameOptionsDeny();
        ...
        /// </summary>
        public ResponseHeaderBuilder AddFrameOptionsDeny()
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddFrameOptionsSameOrigin()
        {
        ...
        public ResponseHeaderBuilder AddFrameOptionsSameOrigin(string uri)
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddXssProtectionEnabled()
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddXssProtectionDisabled()
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddXssProtectionBlock()
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddXssProtectionReport(string reportUrl)
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddStrictTransportSecurityMaxAge(int maxAge = OneYearInSeconds)
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder AddStrictTransportSecurityMaxAgeIncludeSubDomains(int maxAge = OneYearInSeconds)
        {
            _policy.SetHeaders[StrictTransportSecurityConstants.Header] =
        ...
        /// </summary>
        public ResponseHeaderBuilder AddStrictTransportSecurityNoCache()
        {
            _policy.SetHeaders[StrictTransportSecurityConstants.Header] =
        ...
        /// </summary>
        public ResponseHeaderBuilder AddContentTypeOptionsNoSniff()
        {
        ...
        /// </summary>
        public ResponseHeaderBuilder RemoveServerHeader()
        {
        ...
        /// <returns></returns>
        public ResponseHeaderBuilder AddCustomHeader(string header, string value)
        {
        ...
        /// <returns></returns>
        public ResponseHeaderBuilder RemoveHeader(string header)
        {
            if (string.IsNullOrEmpty(header))
            {
                throw new ArgumentNullException(nameof(header));
        ...
        public ResponseHeaderPolicy Build()
        {
            return _policy;
        }
        #endregion
