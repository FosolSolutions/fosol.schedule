...
namespace Fosol.Schedule.DAL.Services
{
  ...
  /// </summary>
  public sealed class SubscriptionService : UpdatableService<Entities.Subscription, Models.Create.Subscription, Models.Read.Subscription, Models.Update.Subscription, Models.Delete.Subscription>, ISubscriptionService
  {
    #region Variables
    #endregion
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Models.Read.Subscription Get(int id)
    {
      return this.Find(id);
    }
    #endregion
