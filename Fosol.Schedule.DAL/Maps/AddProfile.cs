...
namespace Fosol.Schedule.DAL.Maps
{
    ...
    /// </summary>
    public class AddProfile : Profile, IProfileAddMap
    {
        #region Properties
        ...
        public AddProfile()
        {
            CreateMap<Entities.BaseEntity, Models.BaseModel>()
                ...
                .ForMember(dest => dest.AddedById, opt => opt.MapFrom(src => this.DataSource.Principal.GetNameIdentifier().Value.ConvertTo<int>()))
            ...
            CreateMap<Entities.ScheduleEvent, Models.Event>()
                ...
                .ConvertUsing(src =>
                {
                    var cevent = new Entities.Event() 
                    {
                        ...
                        AddedById = src.Id == 0 ? this.DataSource.Principal.GetNameIdentifier().Value.ConvertTo<int>() : src.AddedById.Value,
            ...
            CreateMap<Entities.CalendarTag, Models.Tag>()
                ...
                .ConvertUsing(src =>
                {
                    var tag = new Entities.Tag()
                    {
                        Key = src.Key,
                        Value = src.Value,
                        AddedById = this.DataSource.Principal.GetNameIdentifier().Value.ConvertTo<int>(),
