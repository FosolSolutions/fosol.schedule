...
namespace Fosol.Schedule.API.Areas.Manage.Controllers
{
  ...
  public class ParticipantController : ApiController
  {
    ...
    public IActionResult AddParticipant([FromBody] Models.Create.Participant participant)
    {
      var result = _dataSource.Participants.Add(participant);
      _dataSource.CommitTransaction();

      return Created(Url.RouteUrl(nameof(GetParticipant), new { result.Id }), result);
    }
    ...
    public IActionResult UpdateParticipant([FromBody] Models.Update.Participant participant)
    {
      var result = _dataSource.Participants.Update(participant);
      _dataSource.CommitTransaction();
    ...
    public IActionResult DeleteParticipant([FromBody] Models.Delete.Participant participant)
    {
