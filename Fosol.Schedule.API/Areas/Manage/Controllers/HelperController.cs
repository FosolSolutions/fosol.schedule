...
namespace Fosol.Schedule.API.Areas.Manage.Controllers
{
  ...
  public sealed class HelperController : ApiController
  {
    ...
    [HttpPost("ecclesia")]
    public IActionResult AddEcclesialEvents([FromBody] Models.Update.Calendar calendar, [FromQuery] DateTime? startOn, [FromQuery] DateTime? endOn)
    {
    ...
    public IActionResult AddEcclesialParticipants([FromBody] Models.Update.Calendar calendar)
    {
