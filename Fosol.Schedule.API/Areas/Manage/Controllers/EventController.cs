...
namespace Fosol.Schedule.API.Areas.Manage.Controllers
{
  ...
  public sealed class EventController : ApiController
  {
    ...
    public IActionResult AddEvent([FromBody] Models.Create.Event cevent)
    {
      var result = _dataSource.Events.Add(cevent);
      _dataSource.CommitTransaction();

      return Created(Url.RouteUrl(nameof(GetEvent), new { result.Id }), result);
    }
    ...
    public IActionResult UpdateEvent([FromBody] Models.Update.Event cevent)
    {
      var result = _dataSource.Events.Update(cevent);
      _dataSource.CommitTransaction();
    ...
    public IActionResult DeleteEvent([FromBody] Models.Delete.Event cevent)
    {
