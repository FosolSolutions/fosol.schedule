...
namespace Fosol.Schedule.API.Areas.Data.Controllers
{
  ...
  public sealed class SubscriptionController : ApiController
  {
    ...
    public IActionResult AddSubscription([FromBody] Schedule.Models.Create.Subscription subscription)
    {
      var result = _dataSource.Subscriptions.Add(subscription);
      _dataSource.CommitTransaction();

      return Created(Url.RouteUrl(nameof(GetSubscription), new { result.Id }), result);
    }
    ...
    public IActionResult UpdateSubscription([FromBody] Schedule.Models.Update.Subscription subscription)
    {
      var result = _dataSource.Subscriptions.Update(subscription);
      _dataSource.CommitTransaction();
    ...
    public IActionResult DeleteSubscription([FromBody] Schedule.Models.Delete.Subscription subscription)
    {
